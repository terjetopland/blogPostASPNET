...
// Call the database initializer (temporary variabel) Once every project L19-L26
using (var services = app.Services.CreateScope())
{
    var db = services.ServiceProvider.GetRequiredService<ApplicationDbContext>();
    var um = services.ServiceProvider.GetRequiredService<UserManager<ApplicationUserModel>>();
    var rm = services.ServiceProvider.GetRequiredService<RoleManager<IdentityRole>>();
    
    // Calls our initializer IMPORTANT
